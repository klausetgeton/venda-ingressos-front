...
export default class extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<h1>Selecione os acentos</h1>
				<div class="container-tx">
				<div class="planx plan--shownx">
					<h3 class="plan__title">Seating Plan</h3>
					<div class="rowsx rows--mini">
						...
						<div class="row-acento">
							...
							<div class="row__seat tooltip row__seat--selected" data-tooltip="H4"></div>
							<div class="row__seat tooltip row__seat--selected" data-tooltip="H5"></div>
